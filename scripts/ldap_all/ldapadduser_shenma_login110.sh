...
#setquota 
echo "set the quota of home directory "
ssh root@manager102 setquota -u  $USERNAME    5145728 5145728  0 0 /nfs_share/
ssh root@manager102 quota -u $USERNAME

echo "set the quota of scratch directory "
lfs setquota -u $USERNAME  -b 262144000 -B 267386880  -i 10200000 -I 10500000  /lustre
lfs quota -u $USERNAME -h /lustre 
